...
class ArraysTest {
	...
	void binarySearchTest() {
		...
		int index = Arrays.binarySearch(array2, 30);
		assertEquals(2, index);

		index = Arrays.binarySearch(array2, 10);
		assertEquals(0, index);

		index = Arrays.binarySearch(array2, 70);
		assertEquals(6, index);

		index = Arrays.binarySearch(array2, 45);
		assertEquals(-5, index);

		index = Arrays.binarySearch(array2, 5);
		assertEquals(-1, index);

		index = Arrays.binarySearch(array2, 80);
